const InfoBlock = ({
  ...
  <div className={`overflow-hidden ${bgColor}`}>
    ...
    <div className="px-6 py-10">
      <div className={`font-black text-3xl mb-2 leading-7 ${textColor}`}>
        {title}
      </div>
...
const landingBlocks = [
  ...
  },
  {
    ...
    text: 'Track your engagement triger buildover timessss, monitor revenue and learn what’s converting your audience. Make informed updates on the fly to keep them coming back.',
